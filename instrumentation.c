...
//função acrescentada
//criada para facilitar a criação de ficheiros csv ou txt para importação excel da função de experimentação ImageAnd_Tests.c
//o cabeçalho deverá estar nos ficheiros de teste

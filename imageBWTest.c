...
//função de teste de padrão xadrez
  Image image_chess = ImageCreateChessboard(8, 8, 1, 0 );
  ImageRAWPrint(image_chess);





//teste da função IsEqual
//#1
  if (ImageIsEqual(black_image, image_1 )){
    printf("Teste ImageIsEqual 1: Passou! \n");
  } else {
    printf("Teste ImageIsEqual 1: Fail! \n");
  }
//#2
  if (ImageIsEqual(black_image, image_chess )){
    printf("Teste ImageIsEqual 1: Fail! \n");
  } else {
    printf("Teste ImageIsEqual 1: Passou! \n");
  }
  ...
  Image image_4 = ImageAND(image_1, black_image); //muda-se devido à assertion
  ImageRAWPrint(image_4);
***/
/**
  printf("image_1 OR image_2\n");
  Image image_5 = ImageOR(white_image, image_chess);
  ...
  Image image_7 = ImageXOR(image_1, image_chess);
